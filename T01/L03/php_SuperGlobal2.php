...
<table border="1" cellspacing="2">
	...
	<?php
		...
		echo "<h2>this resource is : ".$_SERVER[PHP_SELF]."</h2>";
	    ...
	    {
		   echo '<tr class="'.$colors[$i++ % 2].'">'; //each table row has dark or light 
		   	//see PHP manual: http://ie.php.net/manual/en/language.operators.arithmetic.php
