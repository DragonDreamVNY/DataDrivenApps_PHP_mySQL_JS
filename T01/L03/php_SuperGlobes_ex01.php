...
<p>URI = http://localhost:8888/COLLEGE_LIT/k00223361/T01/L03/php_SuperGet.php?course=Software%20Development&module=Database%20Systems

<p>Where 'port' and 'path' are the ones used by your web server.
<p>After the question mark (?) - 'course' and 'module' are the variable names used to identify the $_GET array elements. 
<p>After the equals sign (=) is the actual data you are passing through the URL. The symbol '&' separates the variables and the character string '%20' is used whenever a space is required.

<p>Enter the above URL and pass values to it after the  '=' sign. 
