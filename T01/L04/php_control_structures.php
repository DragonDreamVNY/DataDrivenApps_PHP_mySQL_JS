...
<p>
<?php
	$ip = $_SERVER['REMOTE_ADDR']; //web browser's IP address
	$agent = $_SERVER['HTTP_USER_AGENT']; //displays identifier of browser type

	if(strpos($agent, "MSIE") !== false) //strpos is String Pos contained within another String
