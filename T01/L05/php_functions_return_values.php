...
<p>
  ...
  //define functions:
  function buildRows($array) {	//generates a string of html containing the row data and table row element tags
     $rows = '<tr><td>' .
  ...
  function buildTable($rows) {  //adds the table element tags to the rows
